...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fbf8] px-6 py-10 flex flex-col">
      <header className="max-w-6xl mx-auto w-full flex items-center gap-4 pb-6 border-b border-emerald-200/60">
        <div className="flex items-center gap-4">
          ...
          />
          <p className="text-emerald-900 font-semibold text-lg leading-tight">
      ...
      <main className="flex-1 w-full pb-6">
        <div className="max-w-6xl mx-auto text-center text-emerald-800 uppercase tracking-[0.18em] text-[11px] md:text-xs mt-2">
          Unified Intelligence Hub
        </div>

        <div className="max-w-6xl mx-auto text-left mt-4 mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-900 via-emerald-700 to-emerald-800 mt-2 drop-shadow-[0_6px_20px_rgba(16,185,129,0.25)]">
            Unified Analytical Dashboard
          </h1>
          <p className="text-emerald-900/80 mt-3 text-sm md:text-base max-w-3xl">
        ...
        <button
          ...
          className={`group text-left bg-emerald-900/90 border rounded-2xl p-6 shadow-xl shadow-emerald-900/15
                     transition-all duration-200 hover:-translate-y-1 hover:bg-emerald-800/90
                     ${
                       activeArea === "integrated"
                         ? "border-emerald-300 shadow-emerald-400/40 scale-[1.02]"
                         : "border-emerald-700/50 hover:border-emerald-300 hover:shadow-emerald-400/30"
                     }`}
          >
            ...
            <p className="text-emerald-100/70 mt-3 text-sm">
              Unified KPIs across funnel velocity and supply chain.
            </p>
      ...
      <footer className="mt-auto -mx-6 w-auto bg-emerald-950 text-white text-sm text-center py-4">
