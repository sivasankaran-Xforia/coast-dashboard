...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-900 via-emerald-700 to-black px-6 py-10">
      {/* MAIN HEADER */}
      ...
      <p className="text-emerald-100 mt-2 max-w-2xl">
          Choose between CRM and ERP analytics to explore detailed insights.
        </p>
      </div>
